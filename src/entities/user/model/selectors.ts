...
export const signOutStatusSelector = (state: State) => state.user.signOutStatus;
...
export const signOutStatusObjectSelector = createStatusObjectSelector(signOutStatusSelector);
